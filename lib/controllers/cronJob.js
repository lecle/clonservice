...
function getCronResult(data, mongo, analyMongo, callback){
    ...
    function queries( standardTime, newCollectionName, objectId) {
        ...
        var query3 = new Promise(function(resolve, reject) {
            mongo.send( 'aggregate',
                {
                    collectionName: newCollectionName,
                    aggregate: [
        ...
        Promise.all(promises).then(
            ...
            function (reason){
                if(reason === 'notError'){
                    ...
                    exports.container.log.error('getCronResult error ', reason);
                }
            });
    };
...
exports.getAppListTest = function getAppList1(service, callback){

    service.send('find', {  // find
        collectionName: 'apps',
        query : {
            where: {}
        }
...
exports.getMinCreateTimeTest = function getMinCreateTimeD(applist, mongo, callback){
...
exports.getCronResultTest = function getCronResultD(data, mongo, analyMongo, callback){
...
exports.registCronJobTest = function registCronJobD(value, resCB){
    ...
    callbackBowl.callback(job);  // job will ignore at real code
}